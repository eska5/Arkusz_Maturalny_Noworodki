...
CREATE TABLE `noworodki` (
  ...
  `plec` varchar(255) COLLATE latin1_general_ci NOT NULL,
  `imie` varchar(255) COLLATE latin1_general_ci NOT NULL,
  `data_urodzenia` date NOT NULL,
  `waga` int(11) NOT NULL,
  `wzrost` int(11) NOT NULL,
  `identyfikator_matki` int(11) NOT NULL
...
--
ALTER TABLE `noworodki`
  MODIFY `identyfikator` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
